<?php
/*
 * LernovaAI - Account Management Page (Admin)
 * Allows admin to view and update their account information
 */
    ...
    if ($action == 'update_profile') {
        ...
        if (empty($first_name) || empty($last_name) || empty($username)) {
            ...
            if ($stmt_check->get_result()->num_rows > 0) {
                ...
                $stmt_update->bind_param("sssi", $first_name, $last_name, $username, $admin_id);
