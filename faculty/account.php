<?php
/*
 * LernovaAI - Account Management Page (Faculty)
 * Allows faculty to view and update their account information
 */
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($action == 'update_profile') {
        ...
        if (empty($first_name) || empty($last_name) || empty($username)) {
            ...
            $stmt_check->bind_param("si", $username, $faculty_id);
            $stmt_check->execute();
            ...
            if ($stmt_check->get_result()->num_rows > 0) {
                ...
                $stmt_update->bind_param("sssi", $first_name, $last_name, $username, $faculty_id);
        ...
        if (empty($current_password) || empty($new_password) || empty($confirm_password)) {
            ...
            $stmt_verify->bind_param("i", $faculty_id);
            $stmt_verify->execute();
            ...
            if ($result_verify->num_rows == 1) {
                ...
                if (password_verify($current_password, $user['password'])) {
                    ...
                    $stmt_update->bind_param("si", $new_password_hash, $faculty_id);
...
<div class="d-flex justify-content-between align-items-center mb-3">
    <div>
        <h1 class="mb-0"><i class="bi bi-person-gear"></i> Account Management</h1>
        <p class="text-muted mb-0" style="font-size: 0.875rem;">Manage your account information and password</p>
    </div>
</div>
